package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_587:Dictionary;
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_411)
                  {
                     _loc14_ = true;
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_411)
                  {
                     _loc15_ = true;
      ...
      override public function dispose() : void
      {
         ...
         var_588 = null;
         for(_loc1_ in var_587)
         {
            _loc2_ = var_587[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_587[_loc1_];
         }
         var_587 = null;
      }
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = var_587[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
