package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1009:uint = 256;
      ...
      public static const const_1423:uint = 128;
      
      public static const const_1456:uint = 64;
      
      public static const const_510:uint = 4;
      
      public static const const_1135:uint = 0;
      
      public static const const_1214:uint = 16;
      
      public static const const_544:uint = 1;
      
      public static const const_1216:uint = 8;
      ...
      protected var var_1531:Boolean;
      
      protected var var_165:DisplayObjectContainer;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1214:
               ...
               break;
            case GraphicContext.const_510:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1009:
               break;
            case GraphicContext.const_1135:
               break;
            default:
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_165 = new Sprite();
            var_165.name = this.name + " - Child Container";
            var_165.mouseEnabled = false;
            addChild(var_165);
         }
         return var_165;
      }
         ...
         if(var_582)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1531,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1531,16777215);
                  }
                  var_363 += bitmap.width * bitmap.height * 4;
               }
