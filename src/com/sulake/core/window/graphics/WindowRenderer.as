package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1516:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_576 = new Array();
         var_1517 = new Point();
         var_1516 = new Rectangle();
         var_308 = new Rectangle();
         var_309 = new Dictionary(true);
         var_684 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_309[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_576.pop() as WindowController;
            if(!_loc1_.disposed)
            {
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_582,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_309[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1517,var_1516))
            {
               if(param2.render(param1,var_1517,var_1516))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            var_309[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_582,windowDisposedCallback);
         }
      }
