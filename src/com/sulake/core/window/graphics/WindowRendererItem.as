package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_766:uint = 1;
      ...
      private var var_1019:uint;
      
      private var _colorTransform:ColorTransform;
      
      private var var_683:uint;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_453:
               ...
               break;
            case WindowRedrawFlag.const_783:
               var_683 = var_684.method_9(param1.type,param1.style,param1.state);
               if(var_683 != var_1019)
               {
                  var_234 = true;
                  _loc4_ = true;
      ...
      {
         return var_684.method_9(param1.type,param1.style,param1.state) != var_1019;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_683) ? uint(const_766) : uint(_loc5_);
         }
         ...
         if(_loc5_ != const_486)
         {
            if(var_101 == null)
            {
               var_101 = _drawBufferAllocator.allocate(_loc7_,_loc8_,true,param1.color);
               var_234 = true;
            }
            else if(var_101.width != _loc7_ || var_101.height != _loc8_)
            {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_766)
               {
                  ...
                  if(var_234)
                  {
                     ...
                     _loc6_.draw(param1,var_101,var_101.rect,var_683,false);
                     if(!param1.background)
                     {
                        _loc10_ = uint(param1.color);
                        if((_loc10_ & 16777215) < 16777215)
                        {
                           var_101.colorTransform(_loc4_.rect,new ColorTransform(((_loc10_ & 16711680) >> 16) / 255 * 1,((_loc10_ & 65280) >> 8) / 255 * 1,(_loc10_ & 255) / 255 * 1));
                        }
                     }
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_30))
                  {
                     ...
                     _loc4_.draw(var_101,var_883,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_684.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_791)
            {
               _loc2_ = var_684.getSkinRendererByType(param1.type,WindowStyle.const_791);
            }
         }
         return _loc2_;
      }
