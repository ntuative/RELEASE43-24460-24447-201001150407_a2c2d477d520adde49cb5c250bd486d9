package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_754:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_333)
         {
            ...
            if(var_333)
            {
               var_333.addEventListener(WindowEvent.const_257,scrollBarEventProc);
               var_333.addEventListener(WindowEvent.const_213,scrollBarEventProc);
            }
         }
         return var_333;
      }
      ...
      override public function dispose() : void
      {
         if(var_333)
         {
            var_333.removeEventListener(WindowEvent.const_257,scrollBarEventProc);
            var_333.removeEventListener(WindowEvent.const_213,scrollBarEventProc);
            var_333 = null;
         }
         if(var_754)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_754)
         {
            var_754 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_754;
      }
