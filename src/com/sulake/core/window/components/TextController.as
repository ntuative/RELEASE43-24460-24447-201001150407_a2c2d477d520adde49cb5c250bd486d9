package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2257:Rectangle = new Rectangle();
      ...
      protected var var_499:String = "none";
      ...
      {
         return new Rectangle(var_586 * maxScrollH,var_360 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_708)
         {
            context.removeLocalizationListener(var_311,this);
         }
         if(var_72 != null)
         {
            var_72.dispose();
      ...
      {
         var_586 = param1;
         _field.scrollH = var_586 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_311 = param1;
         if(var_311.charAt(0) == "$" && var_311.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_311.slice(2,var_311.indexOf("}")),this);
            var_708 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_172,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_904,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_393,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_172,true));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_172,true));
         ...
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.const_172,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_665,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_172,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_665,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_54,true));
         _loc1_.push(new PropertyStruct("margin_left",var_72.left,PropertyStruct.const_58,true));
         _loc1_.push(new PropertyStruct("margin_top",var_72.top,PropertyStruct.const_58,true));
         _loc1_.push(new PropertyStruct("margin_right",var_72.right,PropertyStruct.const_58,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_72.bottom,PropertyStruct.const_58,true));
         _loc1_.push(new PropertyStruct("auto_size",var_499,PropertyStruct.const_172,var_499 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_665,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_499 = var_499;
         _loc1_.var_708 = var_708;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_499 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_499 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_499 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_499 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
