package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_377:String = "AssetLibraryLoaded";
      
      public static const const_1230:String = "AssetLibraryLoadError";
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(var_466)
         {
            AssetLibrary.fetchLibraryContents(this,var_465,var_345);
         }
         var_296 = true;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_398[param2.url];
         if(_loc4_ != null)
         {
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_975.splice(var_975.indexOf(this),1);
            --var_548;
            var_398 = null;
            var_663 = null;
            _loadedAssets = null;
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_1305);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_398[loader.url];
         if(struct == null)
         {
