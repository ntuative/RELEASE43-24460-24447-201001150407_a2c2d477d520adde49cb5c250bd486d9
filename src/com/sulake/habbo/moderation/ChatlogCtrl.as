package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1404:IMessageComposer;
      ...
      {
         var_819 = IWindowContainer(var_57.getXmlWindow("chatlog_roomheader"));
         var_818 = IWindowContainer(var_57.getXmlWindow("chatlog_chatline"));
         var_472 = new Timer(300,1);
         var_472.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_60 = IFrameWindow(var_57.getXmlWindow("chatlog_frame"));
         ...
         var_57.connection.send(var_1404);
      ...
      private function populateRoomChat(param1:RoomChatlogData) : void
      {
         ...
         if(param1.roomId > 0)
         {
            ...
            new OpenRoomTool(var_60,var_57,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_818.clone());
         _loc4_.color = var_1215[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_60,var_57,_loc6_,param2.chatterId);
         }
