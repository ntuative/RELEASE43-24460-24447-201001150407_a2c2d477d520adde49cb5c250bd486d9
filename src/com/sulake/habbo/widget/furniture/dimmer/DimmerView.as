package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_53,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1052,const_1053,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1030 = _loc2_.light;
         if(var_354 != null)
         {
            var_354.setValue(var_1030);
         }
         var_381 = colors.indexOf(_loc2_.color);
         if(var_497 != null)
         {
            var_497.setSelectedColorIndex(var_381);
         }
