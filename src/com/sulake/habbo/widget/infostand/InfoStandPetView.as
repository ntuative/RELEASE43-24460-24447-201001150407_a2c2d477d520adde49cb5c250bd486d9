package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1604:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1606:String = "level";
      
      private var var_111:IItemListWindow;
      
      private const const_1605:String = "energy";
      
      private var var_1095:Map;
      
      private const const_1603:String = "nutrition";
      ...
      private const const_1602:uint = 11184810;
      
      private const const_1607:String = "experience";
      ...
      private function method_8() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1095.getValue(var_682) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1606,param1.level,param1.levelMax);
         updateStateElement(const_1607,param1.experience,param1.experienceMax);
         updateStateElement(const_1605,param1.energy,param1.energyMax);
         updateStateElement(const_1603,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_682 = param1.id;
         var_1095.remove(param1.id);
         var_1095.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_415,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1602);
         ...
         _loc5_.fillRect(_loc7_,const_1604);
         return _loc5_;
      }
