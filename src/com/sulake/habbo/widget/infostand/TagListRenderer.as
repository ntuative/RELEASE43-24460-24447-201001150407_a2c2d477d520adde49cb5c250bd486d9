package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1598:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1072 != null && var_1072.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_718 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_718 += param1.height + const_1599;
            return fit(param1);
         }
         param1.offset(_offsetX,var_718);
         _offsetX += param1.width + const_1598;
         return true;
      }
