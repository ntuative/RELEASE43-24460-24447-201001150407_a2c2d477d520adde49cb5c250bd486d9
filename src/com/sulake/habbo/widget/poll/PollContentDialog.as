package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_602[var_892] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_285)
         {
            ...
            var_285 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_285.center();
            var_285.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_892;
         if(var_892 < var_602.length)
         {
            _loc1_ = var_602[var_892] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_602.length);
                  _loc2_.text = _loc6_;
               }
