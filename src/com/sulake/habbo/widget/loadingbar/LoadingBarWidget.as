package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_407:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_407 = new Sprite();
            var_407.addChild(new Bitmap(_image));
            var_407.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_407.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_407);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1473 != "")
         {
            HabboWebTools.openWebPage(var_1473);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_407 != null)
         {
            var_407.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_407 = null;
         }
         if(_image != null)
         {
