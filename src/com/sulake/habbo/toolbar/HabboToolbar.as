package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_650.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_874,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_170,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_174,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_44,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_430,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_691,onDisplayWindowEvent);
