package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1376:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_246:ToolbarBarMenuAnimator;
      
      private var var_1375:Number = 5;
      ...
      private var var_919:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_193 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_53,HabboWindowStyle.const_787,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_919 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_919)
         {
            _window.addEventListener(WindowMouseEvent.const_51,onToolbarMouseDown);
            _window.context.getDesktopWindow().getDisplayObject().stage.addEventListener(MouseEvent.MOUSE_MOVE,method_2);
         ...
         var_1129 = _loc7_.toolbar.@margin_bottom;
         var_1376 = _loc7_.toolbar.@min_group_margin;
         var_1375 = _loc7_.toolbar.@margin_to_extrabar;
         var_246 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_255,param1,param2,_window,var_246);
         createGroupsFromXmlList(_loc9_,var_524,param1,param2,var_193,var_246);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_130,var_445,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1376,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1129) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1376,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1129) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_130,var_445);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_524.length)
         {
            _loc2_ = var_524[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_130,var_445);
         }
      }
