package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1121:Number = 90;
      
      private static const const_747:int = 50;
      
      private static const const_1049:Number = 25;
      
      private static const const_1050:int = 50;
      
      private static const const_180:Boolean = true;
       
      
      private var var_530:Timer;
      
      private var var_929:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_450.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_450.splice(_loc3_,1);
            var_449.splice(_loc3_,1);
         }
         var_449.push(param1.name);
         var_450.push(param2);
      ...
      {
         return var_450[var_449.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_929.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_929.getIconLoc(param1.iconId);
      ...
      {
         return var_449[var_450.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_529[_loc3_] = new Array();
            }
            if(var_529[_loc3_].indexOf(param1) < 0)
            {
               var_529[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_747 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_747 || param1.desktop.height - param1.y < const_1050;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_449[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_529[_loc3_].length)
                  {
                     repositionWindow(var_529[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
