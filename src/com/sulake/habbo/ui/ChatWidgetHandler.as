   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         if(var_471 != null)
         {
            ...
            {
               _loc2_ = var_471.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_471.getValue(_loc15_) as BitmapData;
      ...
      {
         return [RoomWidgetChatMessage.const_674,RoomWidgetChatSelectAvatarMessage.const_588];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_674:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_145,_container.roomSession,0,"Version 24460-24447-201001150339");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_301);
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_588:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_817 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_817);
            }
            if(var_470 == null)
            {
               var_469.x = 0;
               var_469.y = 0;
               var_469.z = 0;
               var_470 = _loc4_.getScreenPoint(var_469);
               var_817 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_469.x = 0;
            var_469.y = 0;
            var_469.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_469);
            if(_loc8_ != null)
            {
