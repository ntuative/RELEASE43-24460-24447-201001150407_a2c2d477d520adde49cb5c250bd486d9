package com.sulake.habbo.ui
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_366:
            ...
            case RoomEngineObjectEvent.const_86:
               _container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_894));
         }
      }
      
      public function getWidgetMessages() : Array
      {
         return [RoomWidgetFurniToWidgetMessage.const_573,RoomWidgetDimmerSavePresetMessage.const_680,RoomWidgetDimmerChangeStateMessage.const_725,RoomWidgetDimmerPreviewMessage.const_689];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_573:
               ...
               break;
            case RoomWidgetDimmerSavePresetMessage.const_680:
               if(validateRights())
               {
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_725:
               if(validateRights())
               {
                  _container.roomSession.sendRoomDimmerChangeStateMessage();
               }
               break;
            case RoomWidgetDimmerPreviewMessage.const_689:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionDimmerPresetsEvent.const_366);
