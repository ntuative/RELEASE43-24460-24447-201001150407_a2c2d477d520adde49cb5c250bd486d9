   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_874,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_676,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_372,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_676,onFigureUpdate);
         ...
         if(var_25 != null)
         {
            (var_25 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_900,onAvatarEffectsChanged);
            (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_590,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_372,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_94,onHelpTutorialEvent);
         }
         var_90 = _container.catalog;
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_372:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_440));
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetSelectEffectMessage.const_670);
         ...
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1156);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_802);
         _loc1_.push(RoomWidgetToolbarMessage.const_657);
         _loc1_.push(RoomWidgetToolbarMessage.const_497);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_669);
         ...
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_705);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_651);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_675);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1143);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_572);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_666);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_631);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_723));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_705:
               if(_container != null && false)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_513:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_670:
               if(var_25 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_716:
               ...
               if(var_90 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_684)
               {
               ...
               if(var_25 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_905:
                        var_90.openCatalogPage(CatalogPageName.const_1190,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_912:
                        var_25.toggleInventoryPage(InventoryCategory.const_260);
                        break;
            ...
            case RoomWidgetSetToolbarIconMessage.const_865:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1215:
                     break;
                  default:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_553:
               ...
               break;
            case RoomWidgetToolbarMessage.const_657:
               _loc5_ = param1 as RoomWidgetToolbarMessage;
               if(var_188)
               {
                  var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_25 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
                  ...
                  if(var_90 != null && var_90.getPurse() != null)
                  {
                     _container.events.dispatchEvent(new RoomWidgetCreditBalanceUpdateEvent(var_90.getPurse().credits));
                  }
               }
               if(false)
               {
               ...
               break;
            case RoomWidgetToolbarMessage.const_497:
               _loc6_ = param1 as RoomWidgetToolbarMessage;
               if(var_188)
               {
                  var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_430,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_669:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_461,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_997));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_461,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1179));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_575));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_651:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_675:
            ...
            case RoomWidgetStoreSettingsMessage.const_572:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_318,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_666:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_318,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_631:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_696));
               }
               break;
            default:
