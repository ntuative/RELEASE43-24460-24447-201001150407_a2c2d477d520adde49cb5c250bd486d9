package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_708,RoomWidgetEcotronBoxOpenMessage.const_514,RoomWidgetEcotronBoxOpenedMessage.const_1189];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_708:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_514:
