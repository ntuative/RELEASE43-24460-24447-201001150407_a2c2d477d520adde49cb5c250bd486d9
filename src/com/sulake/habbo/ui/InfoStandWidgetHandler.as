package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_328);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_826);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_782);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_451)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_943)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_615);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_199)
               {
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1293;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_963;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1184);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_512.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_50);
            var_512.add(_loc2_.petId,_loc5_);
         }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_722);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_549);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_611);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_535);
      ...
      public function dispose() : void
      {
         ...
         if(var_512 != null)
         {
            _loc1_ = var_512.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_512.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_418)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_731:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_863,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_228:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_722:
            ...
            case RoomWidgetUserActionMessage.const_404:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_549:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_611:
            ...
            case RoomWidgetUserActionMessage.const_506:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_535:
