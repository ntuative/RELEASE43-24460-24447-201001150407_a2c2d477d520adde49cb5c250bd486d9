package com.sulake.habbo.communication.messages.parser.room.engine
{
   ...
   public class SlideObjectBundleMessageParser implements IMessageParser
   {
      ...
      private var var_776:SlideObjectMessageData = null;
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         switch(_loc14_)
         {
            ...
            case 1:
               ...
               _loc9_ = new Vector3d(_loc2_,_loc3_,_loc11_);
               _loc10_ = new Vector3d(_loc4_,_loc5_,_loc12_);
               var_776 = new SlideObjectMessageData(_loc7_,_loc9_,_loc10_,SlideObjectMessageData.const_789);
               break;
            case 2:
               _loc7_ = param1.readInteger();
               _loc11_ = Number(param1.readString());
               ...
               _loc9_ = new Vector3d(_loc2_,_loc3_,_loc11_);
               _loc10_ = new Vector3d(_loc4_,_loc5_,_loc12_);
               var_776 = new SlideObjectMessageData(_loc7_,_loc9_,_loc10_,SlideObjectMessageData.const_889);
               break;
            default:
