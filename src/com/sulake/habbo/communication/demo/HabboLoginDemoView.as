package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_649:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_338.shockwaveClientUrl = var_117.shockwaveClientUrl;
         var_338.ssoTicket = var_117.ticket;
         var_117.removeEventListener(SSOTicket.const_321,onParsedTicketSuccess);
         var_117.removeEventListener(SSOTicket.const_227,onParsedTicketFailure);
         var_117 = null;
         dispatchEvent(new Event(const_649));
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = var_338.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_456,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function initSSOTicket() : void
      {
         ...
         var_117 = new SSOTicket(var_338.assets,_loc2_,_loc1_);
         var_117.addEventListener(SSOTicket.const_321,onParsedTicketSuccess);
         var_117.addEventListener(SSOTicket.const_227,onParsedTicketFailure);
      }
