package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1530:IWindowContainer;
      
      public static var var_1299:IWindowContainer;
      
      public static var var_1041:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1530 == null)
         {
            ...
            var_1530 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_594 != null)
         {
            toggleCategoryView(var_594,true);
         }
      }
