package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1406:int = 60000;
      ...
      private var var_776:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_494)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_382)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_75.getParts(param1,(var_776 as AvatarImage).getFigure(),_loc6_,var_1189,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_75.getCanvas(var_191,var_1189);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1275[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_813 || _loc32_ == AvatarAction.const_633) && (_loc6_ == AvatarBodyPartType.const_326 || _loc6_ == AvatarBodyPartType.const_1182 || _loc6_ == AvatarBodyPartType.const_1260) && _loc7_.color != null)
               {
