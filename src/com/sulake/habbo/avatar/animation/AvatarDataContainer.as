package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1432,var_1431,var_1433,_alphaMultiplier);
         var_917 = generatePaletteMapForGrayscale(var_1762,var_1761);
      }
      
      public function get reds() : Array
      {
         return var_917.getValue("reds") as Array;
      }
      ...
      {
         return var_917.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_917.getValue("greens") as Array;
      }
      ...
      {
         return var_917.getValue("alphas") as Array;
      }
