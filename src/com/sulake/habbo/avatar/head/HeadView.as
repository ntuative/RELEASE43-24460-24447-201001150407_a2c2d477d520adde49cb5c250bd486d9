package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_677["null"] = new AvatarEditorGridView(param1,FigureData.const_107,param2,param3);
         var_677["null"] = new AvatarEditorGridView(param1,FigureData.const_132,param2,param3);
         var_677["null"] = new AvatarEditorGridView(param1,FigureData.const_140,param2,param3);
         var_677["null"] = new AvatarEditorGridView(param1,FigureData.const_144,param2,param3);
         var_677["null"] = new AvatarEditorGridView(param1,FigureData.const_146,param2,param3);
         attachImages();
         switchCategory(FigureData.const_107);
