package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private var var_1170:LagWarningLogger = null;
      
      private var var_777:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1223,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_724,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_883,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_542:
      ...
      private function onCatalogReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_90.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_90.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_90.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_176)
         {
            Component(var_176).events.addEventListener(HabboConfigurationEvent.const_17,onConfigurationLoaded);
            if(var_218 != null)
            {
               var_218.configuration = var_176;
            }
            if(var_219 != null)
            {
               var_219.configuration = var_176;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_434.events.addEventListener(AdEvent.const_348,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_883,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_724,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_542,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_706,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_455:
               var_1170.registerWarning(LagWarningLogger.const_1002);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_777)
            {
               var_777.release(new IIDHabboWindowManager());
               var_777 = null;
            }
            if(var_434)
            {
               var_434.release(new IIDHabboAdManager());
               var_434 = null;
            }
            if(_navigator)
            {
            ...
            if(var_90)
            {
               if(true)
               {
                  var_90.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_90.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_90.release(new IIDHabboCatalog());
               var_90 = null;
            }
            if(var_25)
            {
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_176)
         {
            Component(var_176).events.removeEventListener(HabboConfigurationEvent.const_17,onConfigurationLoaded);
         }
      }
      ...
      {
         var_777 = IHabboWindowManager(param2);
         if(var_777)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_955 > -1 && _loc2_ < var_955)
         {
            ++var_1420;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1420);
         }
         if(var_955 > -1 && _loc2_ - var_955 > 15000)
         {
            ++var_1419;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1419);
         }
         var_955 = _loc2_;
         if(var_219 != null)
         {
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_706)
         {
