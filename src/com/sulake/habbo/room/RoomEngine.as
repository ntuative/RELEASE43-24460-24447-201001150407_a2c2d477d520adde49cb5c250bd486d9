package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, ICoreUpdateReceiver
   {
      ...
      private static const const_768:String = "overlay";
      ...
      private var var_570:NumberBank;
      ...
      private var var_690:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_305 = new Map();
         var_570 = new NumberBank(1000);
         var_1024 = new Map();
         var_304 = new Map();
         var_70 = new RoomObjectEventHandler(this);
         var_690 = new RoomMessageHandler(this);
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           ...
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_629) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_594) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_585) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_131);
            if(_loc7_ != null)
            {
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_616);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_551);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_639);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_896);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_810);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_937) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_956);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_438,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_526,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_659,var_121,var_122,param2,param3));
            }
         }
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_560,param3);
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_50 != null)
         {
            var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_33);
            var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_29);
            var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_36);
            var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_264);
            var_50.addObjectUpdateCategory(RoomObjectCategoryEnum.const_57);
            var_50.setContentLoader(var_26);
         }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_186,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_328,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_302,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_815,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_826,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_782,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_267,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
         return true;
      }
      ...
      {
         if(_roomObjectFactory == null || var_416 == null || var_50 == null || _roomRendererFactory == null || _communication == null || _habboConfiguration == null || !var_2097)
         {
            return;
         }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1262,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_50.getRoom(getRoomIdentifier(var_121,var_122));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_769,RoomObjectCategoryEnum.const_264);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_121,var_122,var_1274);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_121,var_122,var_1274);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_26 != null)
         {
            var_26.visualizationFactory = var_416;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(_roomObjectFactory != null)
         {
            if(false)
            {
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_212,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_347,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_449,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_236,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_529,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_128,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_86,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_447,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_248,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_473,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_364,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_945,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_397,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(AvatarWalkWarpingWarningEvent.const_455,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_580) != 0)
         {
            return false;
         }
         if(var_70 != null)
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_267,param1,param2,param3,RoomObjectCategoryEnum.const_36));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_29:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_186));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_423);
                     break;
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_729)
         {
            var_2097 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_328,param4,true);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_267,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_434.events.addEventListener(AdEvent.const_348,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_768) as Sprite;
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_490 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_50.getRoom(const_488);
         if(_loc10_ == null)
         {
            _loc10_ = var_50.createRoom(const_488,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_570.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_33:
            case RoomObjectCategoryEnum.const_29:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_186,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_423,param8);
               break;
            case RoomObjectCategoryEnum.const_36:
            ...
            case RoomObjectCategoryEnum.const_57:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_137,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_137,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_614,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_438,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         if(!isRoomObjectContentAvailable(param1) && param5 != null)
         {
            ...
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_957,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_570.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_767,RoomObjectCategoryEnum.const_264);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1498 - _loc12_.width / 2;
               _loc11_.y = var_1499 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_458,var_121,var_122,-1,RoomObjectCategoryEnum.const_216));
                  }
                  _loc13_ = "null";
               }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_121,var_122,var_1274);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1498 - _loc6_.data.width / 2;
               _loc11_.y = var_1499 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_26 != null)
         {
            ...
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_319,param1.image,true);
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_985,param1.adWarningL,true);
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_864,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_840,RoomObjectVariableEnum.const_319,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_26 != null)
         {
            _events.addEventListener(RoomContentLoader.const_729,onContentLoaderReady);
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_50.getRoom(const_488);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_957);
      ...
      {
         return getRoomObjectBoundingRectangle(var_121,var_122,const_272,RoomObjectCategoryEnum.const_57,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_891,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_580,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_935,_loc13_,true);
            if(var_26 != null)
            {
         ...
         else
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_580,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_616,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_594,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_629,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_585,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_907,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_560,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_438,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_194);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_551,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_639,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_551,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_639,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_896,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_810,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_767,const_1106,RoomObjectCategoryEnum.const_264);
         _loc7_.createRoomObject(const_769,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_264);
         return _loc7_;
      }
