package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_661:PlaneVisualization = null;
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_661 = var_391.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_661 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_391 != null)
         {
            ...
            {
               _loc1_ = var_391.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
