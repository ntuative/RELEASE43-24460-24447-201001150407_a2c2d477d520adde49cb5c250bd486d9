package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_914[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_916[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_914 = new Array();
         var_914.push(Math.random() * _loc2_ * 1.5);
         var_914.push(Math.random() * _loc2_ * 1.5);
         var_913 = new Array();
         var_913.push(1);
         var_913.push(-1);
         var_915 = new Array();
         var_915.push(const_1042);
         var_915.push(const_1043);
         var_916 = new Array();
         var_916.push(getRandomAmplitudeFactor());
         var_916.push(getRandomAmplitudeFactor());
      }
