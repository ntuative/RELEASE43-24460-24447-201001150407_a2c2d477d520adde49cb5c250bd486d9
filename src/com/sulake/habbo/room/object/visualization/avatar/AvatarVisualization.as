package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1411:int = 0;
      ...
      private const const_1080:int = 3;
      
      private const const_1619:int = 2;
      
      private var var_806:AvatarVisualizationData = null;
      ...
      {
         var_806 = param1 as AvatarVisualizationData;
         createSprites(const_1077);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc5_:* = var_392.getValue(_loc4_) as IAvatarImage;
         var _loc6_:String = _loc3_.getString(RoomObjectVariableEnum.const_164);
         var _loc7_:Number = new Date().valueOf();
         var _loc8_:Boolean = false;
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_534);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_609);
         ...
         var _loc13_:Number = _loc7_ - var_1219;
         ...
         var _loc15_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_325);
         if(_loc15_ > 0)
         {
         ...
         var _loc19_:Boolean = var_283 != _loc2_.getUpdateID() || var_210 != param1.scale || var_185 != _loc3_.getUpdateID();
         ...
         if(_loc19_ || _loc20_)
         {
            ...
            if(var_520 != _loc6_)
            {
               for each(_loc48_ in var_392.getKeys())
               {
                  var_392.remove(_loc48_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            {
               _loc5_ = var_806.getAvatar(_loc6_,param1.scale);
               if(_loc5_ == null)
               {
                  return;
               }
               var_392.remove(_loc4_);
               var_392.add(_loc4_,_loc5_);
               var_520 = _loc6_;
            }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_290);
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_242) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_242);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_622);
            _loc5_.appendAction(AvatarAction.const_524,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_370);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_384);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_289,AvatarAction.const_1350[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_807);
            if(_loc29_ > 0)
            {
            ...
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_971);
               _loc54_ = 5;
               _loc55_ = _loc7_ - _loc53_;
               if(_loc55_ < _loc54_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_849,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_615);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_608);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_885,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_869);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_886,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_431);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_472) > 0;
            if(_loc34_ || _loc12_)
            {
               _loc5_.appendAction(AvatarAction.const_523);
            }
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_429);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_893);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_710,_loc35_);
            }
            ...
            _loc42_ = getSprite(const_1619);
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_933))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_806.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
            ...
            var_283 = _loc2_.getUpdateID();
            var_185 = _loc3_.getUpdateID();
            var_210 = param1.scale;
            var_805.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_805)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_392 != null)
         {
            _loc1_ = var_392.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_392.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
