package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_330:String = "place_holder";
      
      private static const const_1019:String = const_330;
      ...
      public static const const_729:String = "RCL_LOADER_READY";
      ...
      private var var_885:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_592 = [];
         _wallItems = [];
         var_1542 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1541 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_367 = new Map();
         _events = new Map();
      ...
      {
         var _loc2_:String = var_506.getValue(param1) as String;
      ...
      {
         if(var_166 != null && var_166.hasWorldType(const_270 + param1))
         {
            return var_166.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_592.indexOf(_loc14_) < 0)
                              {
                                 var_592.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              var_506.add(_loc10_,_loc11_);
                              if(_wallItems.indexOf(_loc14_) < 0)
                              {
                                 _wallItems.push(_loc14_);
                              }
                           }
                           _loc16_ = var_427.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_427.remove(_loc14_);
                              var_427.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      public function dispose() : void
      {
         ...
         if(var_317 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_317.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      {
         return [const_330,const_477,ROOM_CONTENT,const_735,const_736];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_505.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_33 || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            ...
            return int(var_427.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1542.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_171 && _loc5_ != RoomObjectLogicEnum.const_118)
         {
            _loc6_ = "@shadow";
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1277);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_506.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1541.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_467,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_358,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_264;
         }
         return RoomObjectCategoryEnum.const_216;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1539)
         {
            ...
            if(var_885 != null)
            {
               var_885.dispatchEvent(new Event(const_729));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_166 != null)
         {
            return var_166.getWorldHeightScale(const_270 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_885 = param1;
            var_1538 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1540 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1544 = param2.getKey("public.room.dynamic.download.url","");
            var_1543 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_734;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_317.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_366 != null)
         {
            var_366.remove(param1);
            var_366.add(param1,param2);
         }
         if(var_365 != null)
         {
            var_365.remove(param2);
            var_365.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_171 && _loc5_ != RoomObjectVisualizationEnum.const_118)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_270 + param1) == RoomObjectCategoryEnum.const_57)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_377,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_166 != null)
         {
            return var_166.getWorldScale(const_270 + param1);
         }
         return 32;
      }
