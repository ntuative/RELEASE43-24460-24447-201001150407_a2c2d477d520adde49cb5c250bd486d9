package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1173:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_459 = false;
         var_649 = false;
         var_54.updateItemList(var_648);
         var_54.updateItemList(var_1183);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_54.alertPopup(TradingView.const_897);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_648)
            {
               var_459 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_649 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_54.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_648)
            {
               var_54.alertPopup(TradingView.const_847);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_459 + " OTHER: " + var_649);
         ...
         {
            case const_157:
               if(param1 == const_163 || param1 == const_220)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_54.setMinimized(param1 != InventoryCategory.const_70);
      ...
      public function close() : void
      {
         if(var_574)
         {
            if(_state != const_157 && _state != const_220)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_157;
            var_25.toggleInventorySubPage(InventorySubCategory.const_949);
            var_574 = false;
         }
         var_54.setMinimized(false);
      }
