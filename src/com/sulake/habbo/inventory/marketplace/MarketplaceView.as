package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         var_2136 = _loc4_.id;
         method_4(_loc4_.data);
         var_2137 = _localization.getKey("roomItem.name." + param1.type);
      ...
      {
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",var_2137);
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","price",var_1513.toString());
      ...
      private function clickHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_156)
         {
