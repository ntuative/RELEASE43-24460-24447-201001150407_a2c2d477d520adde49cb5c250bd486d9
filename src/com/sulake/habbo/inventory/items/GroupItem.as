package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2190:BitmapData;
      ...
      private const const_1401:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1331));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1301);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1401;
               _loc1_.blend = const_1401;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(var_1310 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2190;
               _loc5_.visible = true;
            }
            else
            {
