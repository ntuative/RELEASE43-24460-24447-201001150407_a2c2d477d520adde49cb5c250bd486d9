package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_451 = new Timer(const_1051,1);
         var_451.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_256;
      }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_451 != null)
            {
               var_451.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_451.stop();
               var_451 = null;
            }
            if(var_132 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_305)
         {
         ...
         if(var_626 == null)
         {
            var_626 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_626.clone() as IWindowContainer;
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_387);
      ...
      {
         if(var_753 && param1.type == RoomEngineObjectEvent.const_204)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_303 || _loc3_.category == FurniCategory.const_305 || _loc3_.category == FurniCategory.const_298)
         {
            if(param1)
            {
               return false;
      ...
      public function clearFurniList() : void
      {
         ...
         var_378.add(const_42,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
