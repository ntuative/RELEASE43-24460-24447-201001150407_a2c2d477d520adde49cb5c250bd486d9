package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.reason)
         {
            case CantConnectMessageParser.const_1294:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1169:
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_174,HabboToolbarIconEnum.EXITROOM);
      ...
      private function onRoomExit(param1:IMessageEvent) : void
      {
         ...
         if(!_navigator.mainViewCtrl.method_1())
         {
      ...
      private function onNavigatorSettings(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(_loc6_ && !_navigator.mainViewCtrl.method_1())
            {
               _navigator.mainViewCtrl.onNavigatorToolBarIconClick();
            }
         }
