package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_265,Tabs.const_284);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_265,Tabs.const_635);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_265,Tabs.const_284,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_432 == null)
         {
            var_432 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_432.procedure = onChangeFilter;
