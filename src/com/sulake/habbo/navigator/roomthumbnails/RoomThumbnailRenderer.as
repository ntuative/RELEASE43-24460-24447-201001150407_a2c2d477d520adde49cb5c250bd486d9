package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1073:int = -16;
      
      private static const const_754:int = 32;
      
      private static const const_1074:int = 8;
      ...
      private var var_804:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_804 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_804.getImage(ThumbnailEditorModel.const_32,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1073,_loc4_.y + const_1075 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1955[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_804.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_804.getImage(ThumbnailEditorModel.const_35,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_804.getImage(ThumbnailEditorModel.const_52,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_754 + _loc3_,param2 * const_1074);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1200 == null)
         {
            var_1200 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1200,var_1200.rect,new Point(0,0),null,null,true);
      }
   }
}
