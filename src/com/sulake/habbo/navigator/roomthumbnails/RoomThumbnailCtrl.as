package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1482,this.var_93.mode != ThumbnailEditorModel.const_52);
         setEnabled(var_1483,this.var_93.mode != ThumbnailEditorModel.const_32);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1482 = IButtonWindow(find("top_tab"));
         var_1483 = IButtonWindow(find("obj_tab"));
         var_2044 = IWindowContainer(find("tile_grid"));
         var_2043 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1482,onTopTabButton);
         Util.setProcDirectly(var_1483,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2044;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_2043;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_53,HabboWindowStyle.const_39,HabboWindowParam.const_64,new Rectangle(0,0,param1.width,66)));
