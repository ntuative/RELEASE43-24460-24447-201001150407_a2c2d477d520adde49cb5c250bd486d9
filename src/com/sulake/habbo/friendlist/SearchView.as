package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_680:ITextFieldWindow;
      ...
      {
         var_680 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_680.procedure = onSearchInput;
         var_680.addEventListener(WindowKeyboardEvent.const_112,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            _list.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_274,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_680.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
