package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_223.length / const_279);
      }
      ...
      {
         if(this.var_791 >= this.getPageCount())
         {
            this.var_791 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_791 + 1) * const_279,this.var_223.length);
      }
