package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1028 != null)
         {
            var_1028.removeEventListener(WindowKeyboardEvent.const_112,windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_1028 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1028 != null)
         {
            var_1028.addEventListener(WindowKeyboardEvent.const_112,windowKeyEventProcessor);
         }
      }
