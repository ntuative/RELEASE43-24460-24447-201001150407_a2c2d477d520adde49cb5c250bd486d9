   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         for each(_loc1_ in var_1292)
         {
            ...
            _loc2_.width = var_704.width;
            _loc2_.height = var_704.height;
            _colourGrid.addGridItem(_loc2_);
            _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_704.width,var_704.height,true,0);
               _loc3_.bitmap.copyPixels(var_704,var_704.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_1204.width,var_1204.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_974.width,var_974.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_974,var_974.rect,new Point(0,0),null,null,true);
