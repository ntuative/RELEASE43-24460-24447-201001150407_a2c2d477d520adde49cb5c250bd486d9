package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1133:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_525 != null)
         {
            var_525.visible = false;
            var_525.destroyGridItems();
         }
         if(var_1133 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1194.text = "${" + _loc3_.name + "}";
            var_1195.text = "${" + _loc3_.description + "}";
         }
         else
         {
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_409:
                  _loc4_ = var_1132.clone();
                  if(var_525 != null)
                  {
                     var_525.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_525,var_1133,var_1302);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_193:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_289,AvatarAction.const_650);
                              _loc13_.appendAction(AvatarAction.const_710,_loc6_.productClassId);
      ...
      {
         var_1194 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1195 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1379 = new Point(var_87.x,var_87.y);
         var_525 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1133 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_525 == null)
         {
         ...
         var_1132 = _loc2_.content as BitmapData;
