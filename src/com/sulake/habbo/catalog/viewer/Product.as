package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1140:IProductData;
      ...
      public function Product(param1:CatalogPageMessageProductData, param2:IProductData, param3:IFurnitureData)
      {
         ...
         var_1137 = param1.furniClassId;
         var_927 = param1.extraParam;
         var_926 = param1.productCount;
         var_1139 = param1.expiration;
         var_1140 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_77:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_927);
               break;
