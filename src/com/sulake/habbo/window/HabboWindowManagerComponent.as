package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1074:IEventDispatcher;
      
      private var var_2275:uint = 0;
      
      private var var_1073:ProfilerAgentTask;
      
      private var var_1076:ProfilerOutput;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            _instance = this;
            var_1074 = Component(param1).events;
            var_719 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_284 = new Array(const_331);
         var _loc6_:int = 0;
         while(_loc6_ < const_331)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_600,this,_localization,var_195,new Rectangle(0,0,var_195.stageWidth,var_195.stageHeight),this);
            var_284[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_400 = var_284[const_1027];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_400.getMouseCursor().defineCustomCursorType(MouseCursorType.const_314,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_400.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1287,_loc7_);
      }
      ...
      {
         return var_284[param1].getDesktopWindow().getChildAt(var_400.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1076 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1076 = new ProfilerOutput(_loc3_,this,var_600);
               var_1075 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1075);
               var_1073 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1073);
               var_891 = true;
            }
         }
      }
      ...
      {
         return var_400.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_869.length > 0)
         {
            var_1074.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_331 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1074.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_869.length > 0)
         {
            WindowContext.var_869.flush();
         }
         if(WindowContext.var_1300.length > 0)
         {
            WindowContext.var_1300.flush();
         }
         var_1074.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_719[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_719[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_400.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1142,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1359,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1208,param2.name + ": " + param2.toString());
            }
         }
      }
   }
