package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_370.addStopEventListener(refresh);
      ...
      {
         var _loc2_:Array = var_370.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_370.removeStopEventListener(refresh);
            var_370 = null;
            _windowManager = null;
            var_600 = null;
            _disposed = true;
